...
<div
    ...
    style="background-color: darkred; height: 100px; padding: 30px; margin-top: 741px; display: flex; justify-content: space-between; align-items: center;"
>
    <button type="button" href="./index.php"class="btn btn-primary">
  ...
  <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708z"/>
    ...
    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#guiaModal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="guiaModalLabel">INSTRUCCIONES</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <p>1. -Registro de profesores: En este enlace registramos los profesores de nuevo ingreso</p>
                <p>2. -Registro de Alumnos: Se registran los nuevos alumnos</p>
            </div>
